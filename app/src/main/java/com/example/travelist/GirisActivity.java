...
public class GirisActivity extends AppCompatActivity {
    ...
    TextView txt_kayitSayfasina_Git,edt_password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //edt_password=findViewById(R.id.txt_forgotpassword);
        ...
        /*edt_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(GirisActivity.this,ForgotPassword.class);
        ...
        btn_giris_Yap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_emailGiris) || TextUtils.isEmpty(str_sifreGiris)) {
                    ...
                    Toast.makeText(GirisActivity.this, "Please fill in the blanks", Toast.LENGTH_SHORT).show();
                }
                    ...
                    girisYetkisi.signInWithEmailAndPassword(str_emailGiris, str_sifreGiris)
                            .addOnCompleteListener(GirisActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                {if (task.isSuccessful()){
                                    ...
                                    pdGiris.dismiss();
                                    Toast.makeText(GirisActivity.this,"Wrong E-mail or Password..",Toast.LENGTH_SHORT).show();
                                }
